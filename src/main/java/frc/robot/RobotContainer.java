...
import frc.robot.commands.AutoDriveDistanceForward;
...
public class RobotContainer {
  ...
  // Creates object for autonomous command (Drives 8 inches forward at max speed)
  private final AutoDriveDistanceForward autoDistanceForward = new AutoDriveDistanceForward(drivetrain, 8, 1);
